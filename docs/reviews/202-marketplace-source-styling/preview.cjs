...
const repo=process.argv[2]||'/Users/mbjarland/projects/evalens-worktrees/202-marketplace-source-styling';
...
const out=process.env.EVALENS_PREVIEW_OUT||'/private/tmp/evalens-202';
