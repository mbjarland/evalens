...
export const LEARNING_TOPICS = ['help', 'evaluate', 'results', 'exercises', 'debugger'] as const;
...
export function learningHelpHtml(state: LearningHelpState): string {
  ...
  return `<div id="learning-intro" class="learning-intro"${state.introDismissed ? ' hidden' : ''}>`
